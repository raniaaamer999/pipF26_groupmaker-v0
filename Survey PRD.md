...
|---|---|---|---|---|
| *(example)* school_year | What year are you? | dropdown | First-year / Sophomore / Junior / Senior / Other | no |
| *(example)* working_style | Describe your working style in 1–2 sentences | free text | — | no |
|
| | | | | |
| | | | | |
| | | | | |
